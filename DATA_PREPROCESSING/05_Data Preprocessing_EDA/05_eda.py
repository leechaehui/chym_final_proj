...
# 스케일링 전 (원래 값 범위 해석용)
train_raw = pd.read_csv("../02_Data Preprocessing_missing/train_missing_processed.csv")

# 스케일링 후 (모델 입력과 동일)
train_df = pd.read_csv("../03_Data Preprocessing_scaling/train_final.csv")
valid_df = pd.read_csv("../03_Data Preprocessing_scaling/valid_final.csv")
test_df  = pd.read_csv("../03_Data Preprocessing_scaling/test_final.csv")
...
train_missing = pd.read_csv("../02_Data Preprocessing_missing/train_missing_processed.csv")
...
if len(high_missing) == 0:
    ...
    train_outlier = pd.read_csv(
        "../01_Data Preprocessing_outlier/train_outlier_processed.csv"
    )
