...
print("Exists :", os.path.exists(os.path.join(DATA_DIR, "X_train.npy")))
...
keep_idx = [
    i for i in range(X_train_bin.shape[1])
    if i not in remove_idx
]

X_train_bin = X_train_bin[:, keep_idx]
X_valid_bin = X_valid_bin[:, keep_idx]
X_test_bin = X_test_bin[:, keep_idx]

print("=" * 70)
print("KDIGO VARIABLES REMOVED")
print("=" * 70)
...
with open(
    "outputs1/xgb_stage1_vs_stage23_noKDIGO.pkl",
    "wb"
) as f:
...
valid_metrics.to_csv(
    ...
    "outputs1/validation_metrics.csv",
...
valid_report.to_csv(
    ...
    "outputs1/classification_report_valid.csv"
)
...
test_report.to_csv(
    ...
    "outputs1/classification_report_test.csv"
)
...
plt.savefig(
    ...
    "outputs1/confusion_matrix_valid.png",
...
plt.savefig(
    ...
    "outputs1/confusion_matrix_test.png",
...
importance.to_csv(
    ...
    "outputs1/feature_importance.csv",
...
plt.savefig(
    ...
    "outputs1/feature_importance_top15.png",
...
print("xgb_stage1_vs_stage23.pkl")
