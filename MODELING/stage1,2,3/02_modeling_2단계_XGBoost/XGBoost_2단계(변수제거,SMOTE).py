...
plt.savefig(
    "outputs2/stage_distribution.png",
    dpi=300
)
...
plt.savefig(
    "outputs2/feature_importance_top20.png",
    dpi=300
)
...
results.to_csv(
    "outputs2/stage_model_results.csv",
    index=False
)
...
with open(
    "outputs2/xgb_stage_classifier.pkl",
    "wb"
) as f:
    pickle.dump(
        xgb,
