...
plt.savefig(
    "outputs3/stage_distribution.png",
    dpi=300
)
...
plt.savefig(
    "outputs3/feature_importance_top20.png",
    dpi=300
)
...
importance.to_csv(
    "outputs3/feature_importance.csv",
    index=False
)
...
results.to_csv(
    "outputs3/stage_model_results.csv",
    index=False
)
...
with open(
    "outputs3/xgb_stage_classifier.pkl",
    "wb"
) as f:
    pickle.dump(
        xgb,
