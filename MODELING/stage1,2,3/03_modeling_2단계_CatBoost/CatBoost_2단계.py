...
plt.savefig(
    "outputs3/catboost_performance.png",
    dpi=300
)
...
plt.savefig(
    "outputs3/feature_importance_top15.png",
    dpi=300
)
...
plt.savefig(
    "outputs3/catboost_stage_recall.png",
    dpi=300
)
